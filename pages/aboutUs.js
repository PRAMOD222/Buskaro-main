    ...
    <div className="flex flex-wrap justify-center -m-4">
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center ">
          <img alt="team" className="flex-shrink-0 rounded-lg border-purple-700 w-full h-56 object-cover object-center mb-4  " src="pic1.jpg"/>
          <div className="w-full">
            <h2 className="title-font font-medium text-lg text-gray-900">Pramod Kesarkar</h2>
            <h3 className="text-gray-500 mb-3">Full Stack Devloper</h3>
            <p className="mb-4">Master of web development and can work with HTML CSS JavaScript React and Next.js</p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                <Link href={'https://github.com/PRAMOD222'}><FaGithub className='mx-2 cursor-pointer text-xl' /></Link>
                <a href={'www.linkedin.com/in/pramod-kesarkar-38b87922a'}><FaLinkedinIn className='mx-2 cursor-pointer text-xl' /></a>
